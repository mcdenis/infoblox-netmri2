###########################################################################
## Export of Script Module: netmri_settings_cred_snmp_v2_grids
## Language: Python
## Category: Internal
## Description: Provides access to the 'Settings Cred SNMP V2 Grids' controller of the NetMRI API.\n\nRequires the 'netmri_paging' and the 'netmri_query' libraries.
###########################################################################
class _deps:
...
# TODO use __name__?
_CONTROLLER_TECHNICAL_NAME = "settings_cred_snmp_v2_grids"
...
def index(
    ...
    *,
    ...
    Keyword Parameters
    ------------------
    Same as the `settings_cred_snmp_v2_grids/index` method of the NetMRI API,
